...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"components/_countries.js":[function(require,module,exports) {
...
},{}],"components/_customAddressForm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.bootstrapFnsCustomAddressForm = bootstrapFnsCustomAddressForm;
...
var _require = require('./_locale-infos.js'),
  _locale = _require._locale;
var _require2 = require('./_countries.js'),
  _countries = _require2._countries,
  _cities = _require2._cities,
  _addressPlaceholder = _require2._addressPlaceholder;

// temporaly workaorund
window.callbackMap = function () {
  window.vtexjs.checkout.getOrderForm(function (orderForm) {
    window.vcustom.checkout.customAddressFormInit(orderForm);
  });
};
function bootstrapFnsCustomAddressForm() {
  var bootstrap = new fnsCustomAddressForm();
  return bootstrap;
}
// end temporaly workaorund
var fnsCustomAddressForm = /*#__PURE__*/function () {
  function fnsCustomAddressForm() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      _ref$active = _ref.active,
      active = _ref$active === void 0 ? false : _ref$active;
    (0, _classCallCheck2.default)(this, fnsCustomAddressForm);
  ...
  (0, _createClass2.default)(fnsCustomAddressForm, [{
    key: "loadScript",
    value: function loadScript() {
      $('body').append("<script src=\"https://maps.googleapis.com/maps/api/js?key=".concat(this.googleMapsApiKey, "&language=").concat(window.vtex.i18n.locale, "&libraries=places&callback=callbackMap\"></script>"));
    }
  }, {
    key: "updateAddress",
    value: function updateAddress() {
      var country = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
      var postalCode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
      var city = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
      var state = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';
      var street = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : '';
      var number = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : null;
      var complement = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : '';
      var addressQuery = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : '';
      var addressId = arguments.length > 8 && arguments[8] !== undefined ? arguments[8] : '';
      var geoCoordinates = arguments.length > 9 && arguments[9] !== undefined ? arguments[9] : '';
      this.address = {
        country: country,
    ...
    value: function setForm() {
      var country = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
      var street = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
      var formattedStreet = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
      var number = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';
      var postalCode = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : '';
      ...
      var complement = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : '';
      var neighborhood = arguments.length > 8 && arguments[8] !== undefined ? arguments[8] : '';
      var geoCoordinates = arguments.length > 9 && arguments[9] !== undefined ? arguments[9] : '';
      $('.vcustom--vtex-omnishipping-1-x-address #v-custom-ship-street').val('number' in this.addressrules ? street : formattedStreet);
      ...
      $('.vcustom--vtex-omnishipping-1-x-address #v-custom-ship-street').attr('data-street', country === 'USA' || country === 'ZAF' ? formattedStreet : street);
      ...
      if ($(".vcustom--vtex-omnishipping-1-x-address #ship-state option[value='".concat(state, "']")).length) {
    ...
    key: "updateGoogleForm",
    value: function updateGoogleForm() {
    ...
    key: "returnAddressFRules",
    value: function returnAddressFRules(components, attrs) {
      if (!attrs) return '';
      var _attrs$valueIn = attrs.valueIn,
        valueIn = _attrs$valueIn === void 0 ? 'short_name' : _attrs$valueIn,
        types = attrs.types;
      var _loop = function _loop() {
        var ruleComponent = types[i];
        if (components.find(function (component) {
          return component.types.some(function (v) {
            return v === ruleComponent;
          });
        })) {
          return {
            v: components.find(function (component) {
              return component.types.some(function (v) {
                return v === ruleComponent;
              });
            })[valueIn]
    ...
    key: "googleForm",
    value: function googleForm() {
      var _this = this;
      var input = document.getElementById('v-custom-ship-street');
      var geocodeClient = new window.google.maps.Geocoder();
      _this.gPlacesAutocomplete = new window.google.maps.places.Autocomplete(input);
      _this.gPlacesAutocomplete.addListener('place_changed', function () {
        var place = _this.gPlacesAutocomplete.getPlace();
        ...
        var _countries$find = _countries.find(function (c) {
            return c[0] === place.address_components.filter(function (item) {
              return item.types[0] === 'country';
            })[0].short_name;
          }),
          _countries$find2 = (0, _slicedToArray2.default)(_countries$find, 2),
          country = _countries$find2[1];
        var street = place.address_components.find(function (item) {
          return item.types[0] === 'route';
        }) ? place.address_components.find(function (item) {
          return item.types[0] === 'route';
        }).long_name : place.vicinity;
        var state = _this.returnAddressFRules(place.address_components, _this.addressrules.state);
        var neighborhood = _this.addressrules.neighborhood ? _this.returnAddressFRules(place.address_components, _this.addressrules.neighborhood) : '';
        if ('number' in _this.addressrules) {
          $('.vcustom--vtex-omnishipping-1-x-address #ship-number').val(_this.returnAddressFRules(place.address_components, {
            types: ['street_number']
          }));
        }
        var number = 'number' in _this.addressrules ? $('.vcustom--vtex-omnishipping-1-x-address #ship-number').val() : _this.returnAddressFRules(place.address_components, {
          types: ['street_number']
        });
        var complement = _this.addressrules.complement ? _this.returnAddressFRules(place.address_components, {
          types: ['subpremise']
        }) : $('.vcustom--vtex-omnishipping-1-x-address #ship-complement').val();
        var geoCoordinates = [place.geometry.location.lat(), place.geometry.location.lng()];
        var formattedAddress = $('<div></div>');
        formattedAddress.html(place.adr_address);
        var formattedStreet = $('.street-address', formattedAddress).text();
        var city = _this.returnAddressFRules(place.address_components, _this.addressrules.city) || $('.locality', formattedAddress).text();
        var postalCode = _this.addressrules.postalCode ? _this.returnAddressFRules(place.address_components, {
          types: ['postal_code']
        }) : '00000';
    ...
    key: "triggerAddressValidation",
    value: function triggerAddressValidation() {
    ...
    key: "sendAddress",
    value: function sendAddress(_country, _street, _number, _state, _postalCode, _city, _complement, _addressQuery, _addressId, _neighborhood, geoCoordinates) {
      var _this = this;
      if (~geoCoordinates.indexOf(',')) {
        var _geoCoordinates$split = geoCoordinates.split(','),
          _geoCoordinates$split2 = (0, _slicedToArray2.default)(_geoCoordinates$split, 2),
          lng = _geoCoordinates$split2[0],
          lat = _geoCoordinates$split2[1];
      ...
      fetch("/api/checkout/pub/orderForm/".concat(_this.orderForm.orderFormId, "/attachments/shippingData"), {
        credentials: 'include',
        headers: {
        ...
        if (data.error) {
          ...
          alert("Something went wrong: ".concat(data.error.message));
        } else {
    ...
    value: function getRegions(country) {
      var countryRegions = _cities.find(function (city) {
        return city.countryShortCode === country;
      });
      return countryRegions.regions.map(function (i) {
        return "<option value=\"".concat(i.shortCode, "\">").concat(i.name, "</option>");
      });
    }
  }, {
    key: "getCountries",
    value: function getCountries() {
      ...
      return _this.deliveryCountries.map(function (countryCode) {
        var _i18n = window.vtex.i18n[_this.lang] ? window.vtex.i18n[_this.lang] : window.vtex.i18n[window.vtex.i18n.locale];
        var ret = '';
        if (_i18n.countries[countryCode]) {
          ret = "<option value=\"".concat(countryCode, "\" ").concat(countryCode === _this.mainCountry ? 'selected' : '', ">").concat(_i18n.countries[countryCode], "</option>");
        }
        return ret;
      });
    }
  }, {
    key: "updateFormFieldByCountry",
    value: function updateFormFieldByCountry(addressrules) {
      var number = $('.vcustom--vtex-omnishipping-1-x-address p.ship-number');
      var state = $('.vcustom--vtex-omnishipping-1-x-address p.ship-state');
    ...
    key: "form",
    value: function form(orderForm) {
      var _this = this;
      var shippingData = orderForm.shippingData;
      var country = _countries.find(function (c) {
        return c[1] === _this.mainCountry;
      });
      var form = "\n      <div class=\"vcustom--vtex-omnishipping-1-x-address step\">\n        <div>\n        <form>\n            <p class=\"input v-custom-ship-street required text\"><label id=\"address1-label\" for=\"v-custom-ship-street\">".concat(_this.locale ? _this.locale.address1Placeholder || 'Street address or P.O. Box' : 'Street address or P.O. Box', "</label><input required autocomplete=\"none\" id=\"v-custom-ship-street\" type=\"text\" name=\"v-custom-street\" class=\"input-xlarge\" data-hj-whitelist=\"true\" value=\"").concat(shippingData.address && shippingData.address.street !== null ? shippingData.address.street : '', "\" placeholder=\"Eg: 225 East 41st Street, New York\"><span class=\"help error\" style=\"\">").concat(_this.locale.requiredField ? _this.locale.requiredField : 'This field is required.', "</span></p>\n            <div class=\"v-custom-ship-info\">\n              <p class=\"input ship-number text ").concat('number' in _this.addressrules ? 'required' : 'hide', "\"><label id=\"number-label\" for=\"ship-complement\">").concat(_this.locale.number ? _this.locale.number || 'Number' : 'Number', "</label><input ").concat('number' in _this.addressrules ? 'required' : '', " autocomplete=\"on\" id=\"ship-number\" type=\"text\" name=\"v-custom-number\" maxlength=\"20\" placeholder=\"").concat(_this.locale.number ? _this.locale.number : '', "\" class=\"input-xlarge\" data-hj-whitelist=\"true\" value=\"").concat(shippingData.address ? shippingData.address.number === null ? '' : shippingData.address.number : '', "\"><span class=\"help error\" style=\"\">").concat(_this.locale ? _this.locale.requiredField : 'This field is required.', "</span></p>\n              <p class=\"input ship-complement text\"><label id=\"address2-label\" for=\"ship-complement\">").concat(_this.locale ? _this.locale.address2Placeholder || 'Apartment number, unit, floor, etc.' : 'Apartment number, unit, floor, etc.', "</label><input autocomplete=\"on\" id=\"ship-complement\" type=\"text\" name=\"v-custom-complement\" maxlength=\"750\" placeholder=\"").concat(_this.locale.address2Placeholder ? _this.locale.address2Placeholder : '', "\" class=\"input-xlarge\" data-hj-whitelist=\"true\" value=\"").concat(shippingData.address ? shippingData.address.complement === null ? '' : shippingData.address.complement : '', "\"></p>\n            </div>\n            <div class=\"vcustom--vtex-omnishipping-1-x-address__state\">\n              <p class=\"input ship-country text ").concat(_this.deliveryCountries.length <= 1 ? 'hide' : '', " \"><label id=\"country-label\" for=\"ship-country\">Country</label><select name=\"v-custom-country\" id=\"ship-country\" class=\"input-large\">").concat(_this.getCountries().join(''), "</select></p>\n              <p class=\"input ship-city required text\"><label id=\"city-label\" for=\"ship-city\">").concat(_this.locale ? _this.locale.city || 'City' : 'City', "</label><input required autocomplete=\"on\" id=\"ship-city\" type=\"text\" name=\"v-custom-city\" maxlength=\"100\" class=\"input-large\" data-hj-whitelist=\"true\" value=\"").concat(shippingData.address && shippingData.address.city !== null ? shippingData.address.city : '', "\"><span class=\"help error\" style=\"\">").concat(_this.locale.requiredField ? _this.locale.requiredField : 'This field is required.', "</span></p>\n              <p class=\"input ship-state required text\"><label id=\"state-label\" for=\"ship-state\">").concat(_this.locale ? _this.locale.state || 'State' : 'State', "</label>\n                  <select name=\"v-custom-state\" id=\"ship-state\" class=\"input-large\">\n                    <option value=\"\" disabled selected>").concat(_this.locale ? _this.locale.state : 'State', "</option>\n                    ").concat(_this.getRegions(country[0]).join(''), "\n                  </select>\n              </p>\n              <p class=\"input ship-postalCode required text\"><label id=\"postalCode-label\" for=\"ship-postalCode\">").concat(window.vtex.i18n[_this.lang] ? window.vtex.i18n[_this.lang].cart.postalCode : 'Zip Code', "</label><input required autocomplete=\"on\" id=\"ship-postalCode\" type=\"text\" name=\"receiver\" maxlength=\"").concat(_this.addressrules.postalCodeLength ? _this.addressrules.postalCodeLength : '20', "\" class=\"input-xlarge\" data-hj-whitelist=\"true\" value=\"").concat(shippingData.address ? shippingData.address.postalCode : '', "\"><span class=\"help error\" style=\"\">").concat(_this.locale.requiredField ? _this.locale.requiredField : 'This field is required.', "</span></p>\n            </div>\n            <p class=\"vtex-omnishipping-1-x-submitShippingStepButton btn-submit-wrapper btn-go-to-shipping-wrapper\"><button class=\"submit  btn-go-to-shippping-method btn btn-large btn-success\" id=\"btn-go-to-shippping-method\" type=\"button\">").concat(_this.locale.goToShipping ? _this.locale.goToShipping : 'Continue to shipping', "</button></p>\n        </form>\n        </div>\n      </div>\n    ");
      if (shippingData.address) {
        $('.vcustom--vtex-omnishipping-1-x-address #ship-state').val(shippingData.address.state);
      }
      if ($('.vcustom--vtex-omnishipping-1-x-address.step').length == 0 && shippingData.logisticsInfo[0].selectedDeliveryChannel !== 'pickup-in-point' && $('#shipping-option-pickup-in-point').length) {
      ...
      // sort countries
      var sel = $('.vcustom--vtex-omnishipping-1-x-address #ship-country');
    ...
    key: "submitAddressForm",
    value: function submitAddressForm() {
      var _this = this;
      _this.validateAllFields();
      if (!_this.validate) return;
      var _st = $('.vcustom--vtex-omnishipping-1-x-address #v-custom-ship-street');
      var country = $('.vcustom--vtex-omnishipping-1-x-address #ship-country').val();
      var street = _st.attr('data-street') || '';
      var number = $('.vcustom--vtex-omnishipping-1-x-address #ship-number').val() ? $('.vcustom--vtex-omnishipping-1-x-address #ship-number').val() : _st.attr('data-number') || '';
      var geoCoordinates = _st.attr('data-geocoordinates') || [];
      var neighborhood = _st.attr('data-neighborhood') || null;
      var complement = $('.vcustom--vtex-omnishipping-1-x-address #ship-complement').val();
      var city = $('.vcustom--vtex-omnishipping-1-x-address #ship-city').val();
      var state = $('.vcustom--vtex-omnishipping-1-x-address #ship-state').val();
      var postalCode = $('.vcustom--vtex-omnishipping-1-x-address #ship-postalCode').val();
    ...
    key: "updateFormByCountry",
    value: function updateFormByCountry(countryCode) {
      if (~window.location.host.indexOf('myvtex')) {
      ...
      _this.getCountryRule(country[1]).then(function (rules) {
        _this.addressrules = rules;
        _this.updateFormFieldByCountry(_this.addressrules);
        $("select[name='v-custom-state']").html("".concat(_this.getRegions(country[0]).join('')));
    ...
    value: function bind() {
      ...
      $('body').on('click', '.step.shipping-data #edit-address-button, .step.shipping-data .vtex-omnishipping-1-x-linkEdit', function () {
        if (!$('#shipping-option-pickup-in-point').hasClass('vtex-omnishipping-1-x-deliveryOptionActive')) {
          var indexAddress = $('.vtex-omnishipping-1-x-addressItemOption.vtex-omnishipping-1-x-active').index();
          var addressClicked = window.vtexjs.checkout.orderForm.shippingData;
          if (indexAddress < 0) {
      ...
      $('body').on('change', "select[name='v-custom-country']", function (e) {
        ...
        try {
          ...
          console.error("updateFormByCountry ".concat(this.value, " error:"), err);
        }
      });
    ...
    key: "checkFirstLogin",
    value: function checkFirstLogin(orderForm) {
      var _this = this;
    ...
    key: "getCountryRule",
    value: function getCountryRule(country) {
      var _this = this;
      return fetch("/rules/".concat(country)).then(function (res) {
        return res.json();
      }).then(function (jsonRes) {
        var rules = jsonRes.data,
    ...
    key: "init",
    value: function init(orderForm) {
      var _this = this;
      if (orderForm && window.google && $('.vcustom--vtex-omnishipping-1-x-address').length < 1 && orderForm.items.length) {
        $('body').addClass("".concat(this.classOn));
        _this.orderForm = orderForm;
        _this.getCountryRule(_this.orderForm.storePreferencesData.countryCode).then(function (rules) {
          _this.addressrules = rules;
          _this.checkFirstLogin(orderForm);
          _this.bind();
          _this.events();
          ...
          if (_this.orderForm && _this.orderForm.shippingData) {
            var shippingData = _this.orderForm.shippingData.address;
            if (shippingData) {
  ...
  return fnsCustomAddressForm;
}();
module.exports = fnsCustomAddressForm;
},{"@babel/runtime/helpers/esm/slicedToArray":"../node_modules/@babel/runtime/helpers/esm/slicedToArray.js","@babel/runtime/helpers/esm/typeof":"../node_modules/@babel/runtime/helpers/esm/typeof.js","@babel/runtime/helpers/esm/classCallCheck":"../node_modules/@babel/runtime/helpers/esm/classCallCheck.js","@babel/runtime/helpers/esm/createClass":"../node_modules/@babel/runtime/helpers/esm/createClass.js","./_locale-infos.js":"components/_locale-infos.js","./_countries.js":"components/_countries.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/_customAddressForm.js.map